...
def parse_args():
    ...
    parser.add_argument("--L_g", type=int, default=2, help="Sequence Length of general prompts to be inserted per layer")
    parser.add_argument("--L_s", type=int, default=2, help="Sequence Length of shared prompts to be inserted per layer")
    parser.add_argument("--D_g", type=int, default=4, help="Number of layers (Depth) in which the general prompts will be inserted")
    parser.add_argument("--D_s", type=int, default=8, help="Number of layers (Depth) in which the shared prompts will be inserted")
