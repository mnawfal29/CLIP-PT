...
class CLIPForPromptTuning(nn.Module):
    def __init__(
        self,
        L_g: int = 2,
        L_s: int = 2,
        D_g: int = 3,
        D_s: int = 3,
        text_replace_method: str = "replace",
        vision_replace_method: str = "replace",
    ):
        """
        CLIP Parameter-Efficient
        ...
        self.text_model = CLIPTextModelForPromptTuning(
            ...
            D_g=D_g,
            D_s=D_s,
            deep_replace_method=text_replace_method,
        )
        ...
        self.vision_model = CLIPVisionModelForPromptTuning(
            ...
            D_g=D_g,
            D_s=D_s,
            deep_replace_method=vision_replace_method,
        )
